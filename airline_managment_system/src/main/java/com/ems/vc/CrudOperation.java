...
import com.ems.vc.entity.TicketGenerationPdf;
...
import com.ems.vc.serviceImpl.PassengerServiceImpl;
	...
	public static void crudAdmin()
	{
		...
		while(true)
		{
			...
			case "u":
				...
				String uname= JOptionPane.showInputDialog("ente rusername","type here");
